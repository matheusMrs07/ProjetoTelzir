...
export default function PricesList() {
  ...
  async function handleDelete(id){
    if(window.confirm("Do you really want to delete this price? ")) {
      var result = await api.delete("/api/prices/"+id);
              ...
              <Paper className={classes.paper}>
                ...
                <Grid container spacing={3}>
                  <Grid item xs={12} sm={12}>
                    <Button variant="contained" href={'/prices/create/'} >
                        +New
                    </Button>
                  </Grid>
                  <Grid item xs={12} sm={12}>
                    ...
                    <Table className={classes.table} size="medium" aria-label="a simple table">
                      <TableHead>
                        <TableRow>
                          ...
                          <TableCell align="center">Price per min</TableCell>
                        ...
                        {prices.map((row) => (
                          <TableRow key={row.id}>
                            ...
                            <ButtonGroup color="primary" aria-label="outlined primary button group">
                              <Button color='primary' href={'/prices/edit/'+row.id} >Edit</Button>
